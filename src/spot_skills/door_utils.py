...
class RequestManager:
    ...
    def attributes_set(self):
        ...
        return self.handle_position_side_by_side != None and self.clicked_source != None and self.side_by_side.all() != None
    ...
    def get_handle_and_hinge(self):
        ...
        self.detect_door_handle_in_side_by_side(rotated_fl_img, rotated_fr_img, fl_detected_handles, fr_detected_handles)
...
def test_detect(model_path):
    ...
    for idx in range(0,32):
        image_dict = pkl.load(open(f'/home/aaron/spot_tools/data/images/image_dict_{idx}.pkl', 'rb'))
        ...
        cv2.imwrite(f'/home/aaron/spot_tools/data/images/side_by_side_{idx}.jpg', request_manager.side_by_side)
        # assert request_manager.attributes_set(), 'Failed to get user input for handle and hinge.'
